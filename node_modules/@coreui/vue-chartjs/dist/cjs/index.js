...
function _longestText(ctx, font, arrayOfThings, cache) {
    ...
    for (i = 0; i < ilen; i++) {
        ...
        if (thing !== undefined && thing !== null && !isArray$a(thing)) {
...
const needsSubResolver = (prop, value) => isObject$a(value) && prop !== 'adapters' && (Object.getPrototypeOf(value) === null || value.constructor === Object);
...
class Config {
    ...
    createResolver(scopes, context, prefixes = [
        ...
        return isObject$a(context) ? _attachContext(resolver, context, undefined, descriptorDefaults) : resolver;
    }
}
...
const hasFunction = (value) => isObject$a(value) && Object.getOwnPropertyNames(value).some((key) => isFunction$4(value[key]));
    ...
    setup(props, { expose, emit, slots }) {
        ...
        const computedData = vue.computed(() => typeof props.data === 'function'
            ? canvasRef.value
                ...
                : { datasets: [] }
            : merge$1({}, props.data));
        const computedOptions = vue.computed(() => props.customTooltips
            ? merge$1({}, props.options, {
                plugins: {
                    tooltip: {
                        enabled: false,
                        mode: 'index',
